...
class _PartnerRepository implements PartnerRepository {
  ...
  @override
  Future<ApiResult> selectPartnerRequestList() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'authorization': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<ApiResult> refusePartnerRequest(
      {required Map<String, dynamic> ptRequestQue}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'authorization': 'true'};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(ptRequestQue);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ApiResult>(Options(
      method: 'POST',
      headers: _headers,
  ...
  @override
  Future<ApiResult> setMeetDt({String? meetDt}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResult> setPartnerAlias(String partnerAlias) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'authorization': 'true',
